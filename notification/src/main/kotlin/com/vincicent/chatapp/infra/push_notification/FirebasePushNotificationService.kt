package com.vincicent.chatapp.infra.push_notification
...
import com.vincicent.chatapp.domain.model.PushNotificationSendResult
                        ...
                        DeviceToken.Platform.ANDROID -> {
                            setAndroidConfig(
                                AndroidConfig.builder()
                                    ...
                                    .setRestrictedPackageName("com.vincicent.chatapp")
                                    .build()
                            )
                        }
